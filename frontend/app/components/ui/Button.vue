...
const buttonClasses = computed(() => {
  ...
  const variants = {
    primary:
      'text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 disabled:bg-indigo-300',
    secondary:
      'text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:ring-indigo-500 disabled:bg-indigo-50',
    outline:
      'text-indigo-700 bg-white border border-indigo-300 hover:bg-indigo-50 focus:ring-indigo-500 disabled:bg-gray-50',
    ghost:
      'text-gray-700 bg-transparent hover:bg-gray-100 focus:ring-gray-500 disabled:bg-transparent',
