    ...
    <div class="flex">
      ...
      <div v-if="dismissible" class="ml-auto pl-3">
        <div class="-mx-1.5 -my-1.5">
          <button type="button" :class="dismissClasses" @click="dismiss">
...
const iconClasses = computed(() => `h-5 w-5 ${typeConfig.value.iconColor}`)

const titleClasses = computed(() => `text-sm font-medium ${typeConfig.value.titleColor}`)
